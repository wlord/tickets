...
class RouteDeserializerTest {
    ...
    fun testRouteDeserializerSuccess() {
        ...
        val fromEndpoint = Endpoint(mapOf("station" to Station(0, "Кам`янець-Подільський"), "date" to LocalDateTime.of(2017, 7, 5, 4, 56, 0)))

        val toEndpoint = Endpoint(mapOf("station" to Station(0, "Київ-Пасажирський"), "date" to LocalDateTime.of(2017, 7, 5, 8, 28, 0)))
